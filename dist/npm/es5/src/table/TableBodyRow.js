  ...
  (0, _createClass3.default)(TableBody, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          props = (0, _objectWithoutProperties3.default)(_props2, ["store", "layout", "row", "rowIndex"]);

      var columnsHidden = store.columns.map(function (column, index) {
        return _this3.isColumnHidden(index);
      });
      var rowKey = this.getKeyOfRow(row, rowIndex);
      ...
      ), this.context.store.isRowExpanding(row, rowKey) && React.createElement(
        "tr",
        { key: rowKey + "Expanded" },
        React.createElement(
          "td",
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TableBody, "TableBody", "src/table/TableBodyRow.jsx");

  __REACT_HOT_LOADER__.register(_default, "default", "src/table/TableBodyRow.jsx");
}();
